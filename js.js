...
var a="";
var scroll=($(".conversation-page").scrollTop())+1550;
 var d = new Date();
 var h = d.getHours(); 
 var t = d.getMinutes();
 10>h?h="0"+h:h=h;
...
$("#form")[0].reset(),setTimeout(function(){$(".status").html("online ")},900),setTimeout(function(){$(".status").html("typing... ")},1000),lastmsg=msg.toUpperCase().trim(),$(".conversation-page").scrollTop(scroll),send());
});


$("#name").html("Samir Boro");
function send(){
var sr=lastmsg.split(" ");
var search="";
scroll=($(".conversation-page").scrollTop())+155065;
